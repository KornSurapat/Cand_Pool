...
from Cand_Pool_Funcs import gather_results, blend_results
...
#                                   "ED_Test_Datasets_GlobalED/ace2004_pred.jsonl")
...
#                                   "ED_Test_Datasets_GlobalED/aida_pred.jsonl")
# blended_results = blend_results(gathered_results)
...
#                                   "ED_Test_Datasets_GlobalED/aquaint_pred.jsonl")
# blended_results = blend_results(gathered_results)
...
#                                   "ED_Test_Datasets_GlobalED/cweb_pred.jsonl")
# blended_results = blend_results(gathered_results)
...
#                                   "ED_Test_Datasets_GlobalED/graphq_pred.jsonl")
# blended_results = blend_results(gathered_results)
...
#                                   "ED_Test_Datasets_GlobalED/mintaka_pred.jsonl")
# blended_results = blend_results(gathered_results)
...
#                                   "ED_Test_Datasets_GlobalED/msnbc_pred.jsonl")
# blended_results = blend_results(gathered_results)
...
#                                   "ED_Test_Datasets_GlobalED/reddit_comments_pred.jsonl")
# blended_results = blend_results(gathered_results)
...
#                                   "ED_Test_Datasets_GlobalED/reddit_posts_pred.jsonl")
# blended_results = blend_results(gathered_results)
...
#                                   "ED_Test_Datasets_GlobalED/shadow_pred.jsonl")
# blended_results = blend_results(gathered_results)
...
#                                   "ED_Test_Datasets_GlobalED/tail_pred.jsonl")
# blended_results = blend_results(gathered_results)
...
#                                   "ED_Test_Datasets_GlobalED/top_pred.jsonl")
# blended_results = blend_results(gathered_results)
...
#                                   "ED_Test_Datasets_GlobalED/tweeki_pred.jsonl")
# blended_results = blend_results(gathered_results)
...
gathered_results = gather_results("ED_Test_Datasets_BLINK/webqsp_pred.jsonl",
                                  ...
                                  "ED_Test_Datasets_GlobalED/webqsp_pred.jsonl")
blended_results = blend_results(gathered_results)
