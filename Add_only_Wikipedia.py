  ...
  for d in range(len(result)):
    ...
    for m in range(len(result[d]["predictions"])):
      ...
      for p in range(len(result[d]["predictions"][m]["predictions_all"])):
        ...
        #   if result[d]["predictions"][m]["predictions_all"][p][0] in descriptions and result[d]["predictions"][m]["predictions_all"][p][0] in links:
        #     wikidata_description = descriptions[result[d]["predictions"][m]["predictions_all"][p][0]]
        #     wikidata_link = links[result[d]["predictions"][m]["predictions_all"][p][0]]
        #   else:
        ...
        #       descriptions[result[d]["predictions"][m]["predictions_all"][p][0]] = wikidata_description
        #       links[result[d]["predictions"][m]["predictions_all"][p][0]] = wikidata_link 
        # else:
        #   wikidata_description = None
        #   wikidata_link = None
...
write_jsonl("Added_ED_Test_Datasets_All_2/ace2004_pred.jsonl", added_result)
print("1 done " + "-" * 90)

# 2. aida
added_result = add_description_and_link("ED_Test_Datasets_All/aida_pred.jsonl")
write_jsonl("Added_ED_Test_Datasets_All_2/aida_pred.jsonl", added_result)
print("2 done " + "-" * 90)

# 3. aquaint
added_result = add_description_and_link("ED_Test_Datasets_All/aquaint_pred.jsonl")
write_jsonl("Added_ED_Test_Datasets_All_2/aquaint_pred.jsonl", added_result)
print("3 done " + "-" * 90)

# 4. cweb
added_result = add_description_and_link("ED_Test_Datasets_All/cweb_pred.jsonl")
write_jsonl("Added_ED_Test_Datasets_All_2/cweb_pred.jsonl", added_result)
print("4 done " + "-" * 90)

# 5. graphq
added_result = add_description_and_link("ED_Test_Datasets_All/graphq_pred.jsonl")
write_jsonl("Added_ED_Test_Datasets_All_2/graphq_pred.jsonl", added_result)
print("5 done " + "-" * 90)

# 6. mintaka
added_result = add_description_and_link("ED_Test_Datasets_All/mintaka_pred.jsonl")
write_jsonl("Added_ED_Test_Datasets_All_2/mintaka_pred.jsonl", added_result)
print("6 done " + "-" * 90)

# 7. msnbc
added_result = add_description_and_link("ED_Test_Datasets_All/msnbc_pred.jsonl")
write_jsonl("Added_ED_Test_Datasets_All_2/msnbc_pred.jsonl", added_result)
print("7 done " + "-" * 90)

# 8. reddit_comments
added_result = add_description_and_link("ED_Test_Datasets_All/reddit_comments_pred.jsonl")
write_jsonl("Added_ED_Test_Datasets_All_2/reddit_comments_pred.jsonl", added_result)
print("8 done " + "-" * 90)

# 9. reddit_posts
added_result = add_description_and_link("ED_Test_Datasets_All/reddit_posts_pred.jsonl")
write_jsonl("Added_ED_Test_Datasets_All_2/reddit_posts_pred.jsonl", added_result)
print("9 done " + "-" * 90)

# 10. shadow
added_result = add_description_and_link("ED_Test_Datasets_All/shadow_pred.jsonl")
write_jsonl("Added_ED_Test_Datasets_All_2/shadow_pred.jsonl", added_result)
print("10 done " + "-" * 90)

# 11. tail
added_result = add_description_and_link("ED_Test_Datasets_All/tail_pred.jsonl")
write_jsonl("Added_ED_Test_Datasets_All_2/tail_pred.jsonl", added_result)
print("11 done " + "-" * 90)

# 12. top
added_result = add_description_and_link("ED_Test_Datasets_All/top_pred.jsonl")
write_jsonl("Added_ED_Test_Datasets_All_2/top_pred.jsonl", added_result)
print("12 done " + "-" * 90)

# 13. tweeki
added_result = add_description_and_link("ED_Test_Datasets_All/tweeki_pred.jsonl")
write_jsonl("Added_ED_Test_Datasets_All_2/tweeki_pred.jsonl", added_result)
print("13 done " + "-" * 90)

# 14. webqsp
added_result = add_description_and_link("ED_Test_Datasets_All/webqsp_pred.jsonl")
write_jsonl("Added_ED_Test_Datasets_All_2/webqsp_pred.jsonl", added_result)
print("14 done " + "-" * 90)

# 15. wiki
added_result = add_description_and_link("ED_Test_Datasets_All/wiki_pred.jsonl")
write_jsonl("Added_ED_Test_Datasets_All_2/wiki_pred.jsonl", added_result)
print("15 done " + "-" * 90)